    ...
    return (
        <div className={`p-[1px] bg-gradient-to-b rounded-[72px] from-[#FEFEFE]/30 to-[#8B96B1]/30 overflow-hidden max-[768px]:rounded-3xl ${className}`}>
            <div className="bg-[#1b2031] w-full h-full relative rounded-[72px] flex flex-col items-center justify-start max-[768px]:rounded-3xl">
                <Link href="/projects">
                    <div className="flex flex-col items-center mt-8 max-[768px]:mt-4">
                        <h1 className="text-3xl font-mono">Projects</h1>
                        <p className="text-lg text-white/50">My recent projects</p>
                    </div>
                    <div className="absolute left-0 right-0 -bottom-32 w-full h-full opacity-90 max-[768px]:-bottom-24">
